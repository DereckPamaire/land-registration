...
import connectionProfile from '../../../../../fablo-target/fabric-config/connection-profiles/connection-profile-realtor.json';
...
export async function newGrpcConnection(): Promise<grpc.Client> {
	...
	return new grpc.Client(peerEndpoint, tlsCredentials, {
		'grpc.ssl_target_name_override': connectionProfile.peers['peer0.land.realtor.com'].grpcOptions['ssl-target-name-override'],
	});
}
