...
exports.connectSetTradingStatus = void 0;
...
function connectSetTradingStatus(landTitleId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield setTradingStatus(contract, landTitleId);
        }
        finally {
...
exports.connectSetTradingStatus = connectSetTradingStatus;
...
function setTradingStatus(contract, landTitleId) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(`\n--> Setting Trading of Land Title with ID: ${landTitleId}`);
        try {
            // use evaluate to query the ledger
            const result = yield contract.submitAsync('TransferLandTitle', {
                arguments: [landTitleId]
            });
            const status = yield result.getStatus();
            if (!status.successful) {
                throw new Error(`failed to commit transaction ${status.transactionId} with status code ${status.code}`);
            }
            console.log(`Message from contract ${result.getResult()}`);
